...
type, public :: SIS_transport_CS ; private
  ...
  logical :: mass_neglect_snow_pond !< If true, massless snow and pond values are discarded
...
subroutine ice_cat_transport(CAS, TrReg, dt_slow, nsteps, G, US, IG, CS, uc, vc, mca_tot, uh_tot, vh_tot)
  ...
  h_neg_fix=.false.
  if (CS%mass_neglect_snow_pond) h_neg_fix=.true.
