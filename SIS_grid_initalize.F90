!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~!
! SIS_grid_initialize - sets up grid and processor domains and a wide variety  !
!   of metric terms in a way that is very similar to MOM6. - Robert Hallberg   !
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~!
...
!  call log_version(param_file, mod_nm, version)
  ...
  call log_version(param_file, "SIS_grid_initialize", version, "")
  call get_param(param_file, "SIS_grid_initialize", "GRID_CONFIG", config, &
  ...
  call get_param(param_file, "SIS_grid_initialize", "DEBUG", debug, &
  ...
  select case (trim(config))
    ...
    case ("file"); call MOM_error(FATAL, "SIS_grid_initialize: set_grid_metrics "//&
           'GRID_CONFIG "file" is no longer a supported option.  Use a '//&
           'mosaic file ("mosaic") or one of the analytic forms instead.')
    case default ; call MOM_error(FATAL, "SIS_grid_initialize: set_grid_metrics "//&
...
!  sets of points.
  ...
  call MOM_mesg("  SIS_grid_initialize.F90, set_grid_derived_metrics: deriving metrics", 5)
...
!                         model parameter values.
  ...
  character(len=64)  :: mod="SIS_grid_initialize set_grid_metrics_from_mosaic"
...
!  sets of points.
  ...
  character(len=48) :: mod  = "SIS_grid_initialize set_grid_metrics_cartesian"
